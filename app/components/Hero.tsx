      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex justify-center">
          <div className="relative w-72 md:w-80">
            ...
            {/* Floating Pattern Detected pill */}
            <div className="absolute bottom-12 -left-8 md:-left-16 bg-white/80 backdrop-blur-xl border border-white/60 px-4 py-3 rounded-xl shadow-xl shadow-purple-200/40 flex items-center gap-3 animate-[bounce_4s_ease-in-out_infinite]">
              <div className="w-10 h-10 rounded-full bg-purple-100 text-[#6267c8] flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900 leading-tight">Pattern Detected</p>
                <p className="text-xs text-gray-500 mt-0.5">Preventative action advised.</p>
              </div>
            </div>
          </div>
        </div>
